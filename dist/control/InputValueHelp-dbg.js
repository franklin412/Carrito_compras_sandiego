...
sap.ui.define([
	...
	return Input.extend("zsandiego.Crear_Peticion_Oferta.control.InputValueHelp", {
		...
		init: function() {
            ...
            Input.prototype.onfocusout = function (oEvent) {
                ...
                if (!this.bRenderingPhase){
                    this.onChange({sId: "focusOut", type: "focusOut"})
                }
            };            
            */
        ...
        onModelPropertyChange: function(oEvent){
            if (oEvent.getParameter("path") === "/" + this.getHelpEntitySet()){
                this.onChange({sId:"propertyChange"});
            }
        },
        onAfterRendering: function() {
            ...
            if(sap.ui.core.Control.prototype.onAfterRendering) {
                ...
                this.onChange({sId: "afterRendering"});
